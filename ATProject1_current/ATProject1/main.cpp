	...
	while (true)
	{
		...
		if (PeekMessage(&msg, 0, 0, 0, PM_REMOVE))
		{
			...
			if (msg.message == WM_LBUTTONDOWN)
			{
				...
				for (int i = 0; i < triangle2.getIndicies().size() / 3; i++)
				{
					...
					//Get triangle 
					tV1 = triangle2.getVericies()[triangle2.getIndicies()[(i * 3) + 0]];
					tV2 = triangle2.getVericies()[triangle2.getIndicies()[(i * 3) + 1]];
					tV3 = triangle2.getVericies()[triangle2.getIndicies()[(i * 3) + 2]];
					...
					tri1V1 = DirectX::XMVector3TransformCoord(tri1V1, triangle2.getObjWorld());
					tri1V2 = DirectX::XMVector3TransformCoord(tri1V2, triangle2.getObjWorld());
					tri1V3 = DirectX::XMVector3TransformCoord(tri1V3, triangle2.getObjWorld());
